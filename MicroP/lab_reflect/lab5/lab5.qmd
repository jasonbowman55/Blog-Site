...
### RPS Calculation
The calculations for Revolutions Per Second (RPS) were based on the absolute value of the delta variable. Given that the motor completes one revolution for every 120 pulses, and each pulse corresponds to a unique combination of 2 binary interrupts (resulting in 4 unique combinations), the RPS is determined by Equation [1].

[1] $rps = \frac{1000}{PPR*delta*4}$
